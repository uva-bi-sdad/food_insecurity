...
#1. calculate the standard deduction
     snap$std_deduc <- ifelse(snap$hh_size<=4, 193, ifelse(snap$hh_size==5, 225, 258)) 
#2. calculate the chilcare deduction           
...
snap$snap_housing_metric <- snap$housing_cost_month-(snap$snap_ci*0.50) 
   snap$snap_shelt_deduc <- ifelse(snap$snap_housing_metric>624, 624, 
